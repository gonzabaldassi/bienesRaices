...
?>
    <main class="contenedor seccion contenido-centrado">
        ...
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="entrada.php">
                    ...
                    <p>Escrito en <span>21/8/2023</span> por: <span>Gonzalo Baldassi</span></p>
        ...
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="entrada.php">
                    <h4>Construye una piscina tu hogar</h4>
                    <p>Escrito en <span>21/8/2023</span> por: <span>Gonzalo Baldassi</span></p>
                    <p>
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <img src="build/img/blog3.jpg" alt="entrada de blog" loading="lazy">
                </picture>
            </div>
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <img src="build/img/blog4.jpg" alt="entrada de blog" loading="lazy">
                </picture>
            </div>
